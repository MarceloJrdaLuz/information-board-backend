...
routes.get('/auxiliaryCongregations', (0, permissions_1.is)(['ADMIN_CONGREGATION']), CongregationController_1.default.getAuxiliaryCongregations);
routes.post('/auxiliaryCongregations', (0, permissions_1.is)(['ADMIN_CONGREGATION']), CongregationController_1.default.createAuxiliaryCongregation);
routes.patch('/auxiliaryCongregation/:congregation_id', (0, permissions_1.is)(['ADMIN_CONGREGATION']), CongregationController_1.default.updateAuxiliaryCongregation);
routes.delete('/auxiliaryCongregation/:congregation_id', (0, permissions_1.is)(['ADMIN_CONGREGATION']), CongregationController_1.default.deleteAuxiliaryCongregation);
routes.get('/congregation/:congregation_id/hospitalityGroups', /*is(['ADMIN_CONGREGATION']),*/ HospitalityGroupController_1.default.getHospitalityGroups);
routes.get('/hospitalityGroup/:hospitalityGroup_id', /*is(['ADMIN_CONGREGATION']),*/ HospitalityGroupController_1.default.getHospitalityGroup);
routes.post('/congregation/:congregation_id/hospitalityGroup', /*is(['ADMIN_CONGREGATION']),*/ HospitalityGroupController_1.default.create);
routes.patch('/hospitalityGroup/:hospitalityGroup_id', /*is(['ADMIN_CONGREGATION']),*/ HospitalityGroupController_1.default.update);
routes.patch('/congregation/:congregation_id/groups/reorder', /*is(['ADMIN_CONGREGATION']),*/ HospitalityGroupController_1.default.reorderGroups);
routes.delete('/hospitalityGroup/:hospitalityGroup_id', /*is(['ADMIN_CONGREGATION']),*/ HospitalityGroupController_1.default.delete);
...
routes.post('/talk', /*is(['ADMIN_CONGREGATION']),*/ TalkController_1.default.create);
routes.post('/talks', /*is(['ADMIN_CONGREGATION']),*/ TalkController_1.default.importFromData);
routes.patch('/talk/:talk_id', /*is(['ADMIN_CONGREGATION']),*/ TalkController_1.default.update);
routes.delete('/talk/:talk_id', /*is(['ADMIN_CONGREGATION']),*/ TalkController_1.default.delete);
routes.get('/talk/:talk_id', /*is(['ADMIN_CONGREGATION']),*/ TalkController_1.default.getTalk);
routes.get('/talks', /*is(['ADMIN_CONGREGATION']),*/ TalkController_1.default.getTalks);
routes.get('/congregation/:congregation_id/weekendSchedules', /*is(['ADMIN_CONGREGATION']),*/ WeekendScheduleController_1.default.getSchedules);
routes.get('/weekendSchedule/:weekendSchedule_id', /*is(['ADMIN_CONGREGATION']),*/ WeekendScheduleController_1.default.getSchedule);
routes.post('/congregation/:congregation_id/weekendSchedule', /*is(['ADMIN_CONGREGATION']),*/ WeekendScheduleController_1.default.create);
routes.patch('/weekendSchedule', /*is(['ADMIN_CONGREGATION']),*/ WeekendScheduleController_1.default.update);
routes.delete('/weekendSchedule/:weekendSchedule_id', /*is(['ADMIN_CONGREGATION']),*/ WeekendScheduleController_1.default.delete);
routes.post("/weekends", (0, permissions_1.is)(["ADMIN_CONGREGATION"]), HospitalityController_1.default.createWeekendsBatch);
routes.put("/assignment/:assignment_id/status", (0, permissions_1.is)(["ADMIN_CONGREGATION"]), HospitalityController_1.default.updateAssignmentStatus);
routes.put("/assignment/:assignment_id", (0, permissions_1.is)(["ADMIN"]), HospitalityController_1.default.updateAssignment);
routes.delete("/assignment/:assignment_id", (0, permissions_1.is)(["ADMIN"]), HospitalityController_1.default.deleteAssignment);
routes.delete("/weekend/:weekend_id", (0, permissions_1.is)(["ADMIN"]), HospitalityController_1.default.deleteWeekend);
routes.get('/weekends', /*is(['ADMIN_CONGREGATION']),*/ HospitalityController_1.default.getWeekends);
routes.post('/congregation/:congregation_id/externalTalks', /*is(['ADMIN_CONGREGATION']),*/ ExternalTalkController_1.default.create);
routes.get('/congregation/:congregation_id/externalTalks/', /*is(['ADMIN_CONGREGATION']),*/ ExternalTalkController_1.default.getExternalTalks);
routes.get('/congregation/:congregation_id/externalTalks/period', /*is(['ADMIN_CONGREGATION']),*/ ExternalTalkController_1.default.getExternalTalksByPeriod);
routes.patch('/externalTalk/:externalTalk_id', /*is(['ADMIN_CONGREGATION']),*/ ExternalTalkController_1.default.update);
routes.patch('/externalTalk/:externalTalk_id/status', /*is(['ADMIN_CONGREGATION']),*/ ExternalTalkController_1.default.updateStatus);
routes.delete('/externalTalk/:externalTalk_id', /*is(['ADMIN_CONGREGATION']),*/ ExternalTalkController_1.default.delete);
routes.get('/speakers', /*is(['ADMIN_CONGREGATION']),*/ SpeakerController_1.default.getSpeakers);
routes.get('/my-congregation/speakers', /*is(['ADMIN_CONGREGATION']),*/ SpeakerController_1.default.getPublishersSpeaker);
routes.get('/speaker/:speaker_id', /*is(['ADMIN_CONGREGATION']),*/ SpeakerController_1.default.getSpeaker);
routes.post('/speaker', /*is(['ADMIN_CONGREGATION']),*/ SpeakerController_1.default.create);
routes.patch('/speaker/:speaker_id', /*is(['ADMIN_CONGREGATION']),*/ SpeakerController_1.default.update);
routes.delete('/speaker/:speaker_id', /*is(['ADMIN_CONGREGATION']),*/ SpeakerController_1.default.delete);
routes.get('/form-data', /*is(['ADMIN_CONGREGATION', 'PUBLISHERS_MANAGER']),*/ FormDataController_1.default.getFormData);
