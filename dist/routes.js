...
routes.post('/talk', (0, permissions_1.is)(['ADMIN_CONGREGATION', 'TALK_MANAGER']), TalkController_1.default.create);
routes.post('/talks', (0, permissions_1.is)(['ADMIN_CONGREGATION', 'TALK_MANAGER']), TalkController_1.default.importFromData);
routes.patch('/talk/:talk_id', (0, permissions_1.is)(['ADMIN_CONGREGATION', 'TALK_MANAGER']), TalkController_1.default.update);
routes.delete('/talk/:talk_id', (0, permissions_1.is)(['ADMIN_CONGREGATION', 'TALK_MANAGER']), TalkController_1.default.delete);
routes.get('/talk/:talk_id', (0, permissions_1.is)(['ADMIN_CONGREGATION', 'TALK_MANAGER']), TalkController_1.default.getTalk);
routes.get('/talks', (0, permissions_1.is)(['ADMIN_CONGREGATION', 'TALK_MANAGER']), TalkController_1.default.getTalks);
