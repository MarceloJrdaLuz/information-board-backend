...
routes.get("/midweek/schedules/congregation/:congregation_id", (0, permissions_1.is)(["ADMIN", "ADMIN_CONGREGATION", "MIDWEEK_MANAGER", "VIEWER"]), (0, permissions_1.is)(["ADMIN", "ADMIN_CONGREGATION", "MIDWEEK_MANAGER", "VIEWER", "MIDWEEK_VIEWER"]), midweekController.getMonthSchedules.bind(midweekController));
routes.get("/midweek/schedules/:schedule_id/congregation/:congregation_id", (0, permissions_1.is)(["ADMIN", "ADMIN_CONGREGATION", "MIDWEEK_MANAGER", "VIEWER"]), (0, permissions_1.is)(["ADMIN", "ADMIN_CONGREGATION", "MIDWEEK_MANAGER", "VIEWER", "MIDWEEK_VIEWER"]), midweekController.getScheduleById.bind(midweekController));
